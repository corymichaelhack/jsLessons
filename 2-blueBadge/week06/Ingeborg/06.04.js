...
//update react to include hooks;
/*
Broken React App Challenge

* 1. Main.js import should be from './components/Main';

* 2. Extra Parenthesis in toggle villain surrounding the character;

* 3. No parent <div> in Main's return;

* 4. VillainButton is not being exported;

* 5. Main.js's import for useState is incorrect, should be wrapped in curly braces;

* 6. in the map for characters, the .map() character param is capitalized, all other times it is lower case; 
