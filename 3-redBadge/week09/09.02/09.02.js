...
/*
Under app directory, create a folder called display-books.  Under it, add display-books.component.ts, display-books.component.html, and display-books.component.css. 
...
For more info, go here: https:  //angular.io/guide/forms-overview
*/
...
Then a button that sends a service action that sends a get request to this url (as an example for the people API)
